...
//add begin:
#ifdef MTK_D5028M_BLU_GMO
    if((BMT_status.charger_exist == KAL_TRUE)&&(BMT_status.charger_type == STANDARD_HOST)) 
    {
        if((abs(oam_i_1) > 8000) || (abs(oam_i_2) > 8000))
        { 
            oam_i_1 = -5000;
            oam_i_2 = -5000;
        }
    ...
    else if((BMT_status.charger_exist == KAL_TRUE)&&(BMT_status.charger_type == STANDARD_CHARGER))
    {
        if((abs(oam_i_1) > 9500) || (abs(oam_i_2) >9500))
        { 
            oam_i_1 = -8000;
            oam_i_2 = -8000;
        }
