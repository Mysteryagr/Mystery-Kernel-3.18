...
static int msdc_info_proc_show(struct seq_file *m, void *v)
{

		if (mtk_msdc_host[0]) {
			switch(mtk_msdc_host[0]->hw->clk_src)
				{
					case 0:
							seq_printf(m, "MSDC0_CLK = 125MHZ,");
							break;
					case 1:
							seq_printf(m, "MSDC0_CLK = 150MHZ,");
							break;
					case 2:
							seq_printf(m, "MSDC0_CLK = 187MHZ,");
							break;
					case 3:
							seq_printf(m, "MSDC0_CLK = 178MHZ,");
							break;
					case 4:
							seq_printf(m, "MSDC0_CLK = 214MHZ,");
							break;
					case 5:
							seq_printf(m, "MSDC0_CLK = NONE,");
							break;
					case 6:
							seq_printf(m, "MSDC0_CLK = 26MHZ,");
							break;
					case 7:
							seq_printf(m, "MSDC0_CLK = 208MHZ,");
							break;
					case 8:
							seq_printf(m, "MSDC0_CLK = MAX,");
							break;
			}
	}

	if (mtk_msdc_host[1]) {
					switch(mtk_msdc_host[1]->hw->clk_src)
				{
					case 0:
							seq_printf(m, "MSDC1_CLK = 125MHZ\n");
							break;
					case 1:
							seq_printf(m, "MSDC1_CLK = 150MHZ\n");
							break;
					case 2:
							seq_printf(m, "MSDC1_CLK = 187MHZ\n");
							break;
					case 3:
							seq_printf(m, "MSDC1_CLK = 178MHZ\n");
							break;
					case 4:
							seq_printf(m, "MSDC1_CLK = 214MHZ\n");
							break;
					case 5:
							seq_printf(m, "MSDC1_CLK = NONE\n");
							break;
					case 6:
							seq_printf(m, "MSDC1_CLK = 26MHZ\n");
							break;
					case 7:
							seq_printf(m, "MSDC1_CLK = 208MHZ\n");
							break;
					case 8:
							seq_printf(m, "MSDC0_CLK = MAX\n");
							break;
...
static int msdc_info_proc_open(struct inode *inode, struct file *file)
{
	return single_open(file, msdc_info_proc_show, inode->i_private);
}
...
static const struct file_operations msdc_info_fops = {
	.open = msdc_info_proc_open,
	.read = seq_read,
	.llseek = seq_lseek,
...
int msdc_debug_proc_init(void)
{
	...
	/****add for 9375 start*****/
	prEntry = proc_create("msdc_clkInfo",0660,NULL,&msdc_info_fops);
	if(prEntry){
		pr_err("[%s]: successfully create /proc/msdc_clkInfo\n", __func__);
		proc_set_user(prEntry, uid, gid);
	} else {
		pr_err("[%s]: failed to create /proc/msdc_clkInfo\n", __func__);
	}
	/****add for 9375 end****/
