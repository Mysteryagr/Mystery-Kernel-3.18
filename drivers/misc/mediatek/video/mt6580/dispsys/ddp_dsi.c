...
#include "ddp_reg.h"
#include "ddp_path.h"
/*************add by wanghanfeng modify rgk_lcm_params_info_show *****start(2016-03-17)****************/
#include <linux/seq_file.h>
#include <linux/proc_fs.h> 
static unsigned int lcm_clock;
/*************add by wanghanfeng modify rgk_lcm_params_info_show *****end(2016-03-17)****************/
...
/*************add by wanghanfeng modify rgk_lcm_params_info_show *****start(2016-03-17)****************/
	static int rgk_lcm_params_info_show(struct seq_file *m, void *v)
   {
	   seq_printf(m, "%d\n", lcm_clock);	
	  //seq_printf(m, "%s\n", "1111");	
	    return 0;
   }
  static int rgk_lcm_params_info_open(struct inode *inode, struct file *file)
   {
	    return single_open(file, rgk_lcm_params_info_show, NULL);
   }
  static const struct file_operations rgk_lcm_params_info_proc_fops = {	
	.owner      = THIS_MODULE,
	.open       = rgk_lcm_params_info_open,
	.read       = seq_read,
	.llseek     = seq_lseek,
	.release    = single_release,
    };
  int rgk_creat_proc_lcm_params_info(void)
   {
	    struct proc_dir_entry *lcm_params_info_entry = proc_create("rgk_lcd_params_Info", 0444, NULL, &rgk_lcm_params_info_proc_fops);
	    if (lcm_params_info_entry == NULL)
...
{
	/*************add by wanghanfeng modify rgk_lcm_params_info_show *****start(2016-03-17)****************/ 
	rgk_creat_proc_lcm_params_info();
	/*************add by wanghanfeng modify rgk_lcm_params_info_show *****end(2016-03-17)*****************/
...
void _dump_dsi_params(LCM_DSI_PARAMS *dsi_config)
{
	if (dsi_config) {
		...
		DISPCHECK(
		 ...
		 /*************add by wanghanfeng modify rgk_lcm_params_info_show *****start(2016-03-17)****************/
	   lcm_clock = dsi_config->PLL_CLOCK;
     DISPCHECK("@@@@@@@lcm_clock = %d@@@@@@@\n",lcm_clock);
	   /*************add by wanghanfeng modify rgk_lcm_params_info_show *****end(2016-03-17)****************/
		DISPCHECK
