...
#define ALSPS_FUN(f)			pr_err(APS_TAG"%s %d \n ", __func__, __LINE__)
#define ALSPS_ERR(fmt, args...)	pr_err(APS_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define ALSPS_LOG(fmt, args...)	pr_err(APS_TAG "%s %d : "fmt, __func__, __LINE__,##args)
#define ALSPS_VER(fmt, args...)    pr_err(APS_TAG "%s %d : "fmt, __func__, __LINE__, ##args) 

#define ALSPS_FUNC() 	pr_err(APS_TAG"%s %d \n ", __func__, __LINE__)
