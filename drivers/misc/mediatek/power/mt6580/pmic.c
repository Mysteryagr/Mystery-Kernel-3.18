...
#ifdef KPD_PMIC_RSTKEY_MAP        
       ret=pmic_config_interface(0x40,0x0,0x1,0); //lj 
       ret=pmic_config_interface(0x40,0x0,0x1,1); //lj 
       ret=pmic_config_interface(0x40,0x1,0x1,2); //lj 
       ret=pmic_config_interface(0x16c,0x1,0x1,3); //lj  
#endif
}
