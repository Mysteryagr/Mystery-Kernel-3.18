...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0xdb1ed3a6,        //checksum value for Camera Auto Test
...
write_cmos_sensor(0x27,0x9b);//bb
write_cmos_sensor(0x28,0x4f);//7f
write_cmos_sensor(0x21,0x0c);//4//4d
write_cmos_sensor(0x22,0x48);
write_cmos_sensor(0xfd,0x00);	
write_cmos_sensor(0x24,0x28);//20
write_cmos_sensor(0x0a,0x06);
write_cmos_sensor(0x01,0x01);
write_cmos_sensor(0xfd,0x01);
write_cmos_sensor(0xfb,0x73);
write_cmos_sensor(0x15,0x50);//20
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
 ...
 if (enable) {
 	write_cmos_sensor(0xfd, 0x00);
    write_cmos_sensor(0x0d,0x01);//3?\A8\AA?
