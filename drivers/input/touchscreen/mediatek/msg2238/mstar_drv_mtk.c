...
{
	if(pMajor==0xc){
		len=sprintf(tp_info,"TP IC:%s,TP MODULE:%s,TP I2C ADR:0x%x,SW FirmWare:%x.%x,Sample FirmWare:%x.%x","MSG2238","JUNDA",client->addr,pMajor,pMinor,SAMPLE_FWVER_JUNDA_MAJOR,SAMPLE_FWVER_JUNDA_MINOR);
	}else{
